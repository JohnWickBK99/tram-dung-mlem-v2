/**
 * Chip — sticker pill theo handoff (v1.4).
 *
 * Variants:
 *   - cream (default): bg cream + text ink + border ink + shadow ink
 *   - yellow: bg yellow + text ink
 *   - coral:  bg coral + text white
 *   - teal:   bg teal + text ink
 *   - ink:    bg ink + text yellow
 *   - lg:     fontSize 52 + padding 16/38 + shadow 14/14 + border 6 (cho hero chip)
 */
